      ...
      <div id="loginright">
        <el-form :model="user" style="width: 80%" :rules="rules" ref="registerRef">
          ...
          <el-form-item prop="username">
            <el-input :prefix-icon="User" size="large" placeholder="请输入用户名" v-model="user.username"></el-input>
          </el-form-item>
          <el-form-item prop="email">
            <el-input :prefix-icon="Message" size="large" placeholder="请输入邮箱" v-model="user.email"></el-input>
          </el-form-item>
